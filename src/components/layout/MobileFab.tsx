...
function SpeedDialLink({
  ...
  return (
    <Link
      href={href}
      role="menuitem"
      className={`inline-flex items-center gap-2 h-11 pl-3 pr-4 rounded-full text-white font-medium text-sm shadow-[var(--shadow-3)] whitespace-nowrap w-max max-w-[70vw] ${bg} hover:opacity-90 transition-all focus:outline-none focus-visible:ring-4 focus-visible:ring-white/40`}
    >
