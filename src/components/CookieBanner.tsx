...
export function CookieBanner() {
  ...
  return (
    <div
      ...
      className="glass-surface-strong fixed left-2 right-2 md:left-auto md:right-6 md:max-w-md z-[var(--z-cookie)] rounded-[var(--radius-md)] md:rounded-[var(--radius-lg)] shadow-[var(--shadow-4)] p-3 md:p-5 animate-fade-in-up bottom-[calc(env(safe-area-inset-bottom,0px)+5.5rem)] lg:bottom-[calc(env(safe-area-inset-bottom,0px)+0.5rem)]"
    >
