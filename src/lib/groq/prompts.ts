...
7. INTERZIS dramatizare neverificată — „pietonii sunt forțați să circule pe carosabil", „risc iminent", „pericol de moarte", „blocat complet" — DOAR dacă fotografia confirmă. Dacă fotografia arată trotuar lat cu mașini doar pe o parte, scrie EXACT ce vezi: „mașinile ocupă aproximativ X% din lățimea trotuarului, rămâne spațiu de trecere de aproximativ Y metri".
