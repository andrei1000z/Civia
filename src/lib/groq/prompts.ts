...
- "parcare" — o MAȘINĂ parcată ilegal, pe trotuar, blocaje, parcare sălbatică, CIRCULAȚIE/condus pe trotuar sau pe spațiul pietonal (vehicul unde n-ar trebui să fie). NU pentru un marcaj de parcare trasat ilegal (→ „parcare_trasata").
- "parcare_trasata" — cineva a TRASAT / VOPSIT / DESENAT ILEGAL un loc de parcare pe domeniul public (marcaj de parcare neautorizat, „și-a făcut singur loc de parcare", „ne trasăm singuri locuri de parcare", loc privat marcat pe stradă fără autorizație). DISTINCȚIE STRICTĂ: „parcare" = o MAȘINĂ parcată ilegal (sancționezi mașina); „parcare_trasata" = MARCAJUL trasat ilegal pe asfalt (sancționezi cine l-a trasat + ștergerea lui); „amenajare_parcare" = CERERE legitimă de a crea locuri. Semnal: „trasat/vopsit/desenat" + „loc de parcare" + „ilegal/singur/abuziv".
...
- "trecere_pietoni" — CERERE DE AMENAJARE zebră/trecere pietoni NOUĂ (marcaj rutier acolo unde nu există ÎNCĂ). Distincție vs „semafor": zebră ștearsă e „semafor", zebră CERUTĂ unde nu e niciuna e „trecere_pietoni". Dacă cererea e despre un SEMAFOR (nu doar marcaj), alege „semaforizare".
- "semaforizare" — CERERE de montare a unui SEMAFOR NOU / semaforizarea unei intersecții sau treceri de pietoni (unde NU există încă semafor). Cuvinte cheie: „instalare semafor", „montare semafor", „semaforizare", „semafor la intersecție/trecere", „să se pună un semafor". DISTINCȚIE STRICTĂ vs „semafor": semafor EXISTENT defect/stricat = „semafor"; CERERE de semafor nou unde nu e niciunul = „semaforizare".
