...
const MAP: Record<string, string> = {
  ...
  // 2026-06-05 — extindere din audit (cuvinte de conținut frecvente, univoce)
  cand: "când", vant: "vânt", vantul: "vântul", vanturi: "vânturi",
  langa: "lângă", afise: "afișe", afisul: "afișul", afisaj: "afișaj",
  afisaje: "afișaje", afisajul: "afișajul", atarnate: "atârnate",
  atarnat: "atârnat", atarna: "atârnă", arata: "arată",
  sobolan: "șobolan", sobolani: "șobolani", sobolanii: "șobolanii",
  acoperis: "acoperiș", acoperisul: "acoperișul", asteptam: "așteptăm",
  asteapta: "așteaptă", asteptare: "așteptare", asteptand: "așteptând",
  saptamana: "săptămână", saptamani: "săptămâni", saptamanal: "săptămânal",
  scantei: "scântei", scanteie: "scânteie", stapan: "stăpân", stapani: "stăpâni",
  latra: "latră", latrat: "lătrat", trecator: "trecător", trecatori: "trecători",
  trecatorii: "trecătorii", lipseste: "lipsește", lipsesc: "lipsesc",
  strazii: "străzii", poti: "poți", cosul: "coșul",
  dezgustator: "dezgustător", dezgustatoare: "dezgustătoare",
  mazgalituri: "mâzgălituri", mazgalitura: "mâzgălitură",
  inundatie: "inundație", inundatii: "inundații", inundatia: "inundația",
  infundat: "înfundat", infunda: "înfundă", infundata: "înfundată",
  spatiu: "spațiu", spatiul: "spațiul", spatii: "spații", spatiile: "spațiile",
  spatiului: "spațiului", piata: "piața", statia: "stația", statie: "stație",
  statii: "stații", statiei: "stației", intersectia: "intersecția",
  intersectie: "intersecție", intersectii: "intersecții", intersectiei: "intersecției",
  carucior: "cărucior", caruciorul: "căruciorul", caruciorului: "căruciorului",
  denivelari: "denivelări", denivelarile: "denivelările", iroseste: "irosește",
  cladire: "clădire", cladirea: "clădirea", aproximativ: "aproximativ",
};
